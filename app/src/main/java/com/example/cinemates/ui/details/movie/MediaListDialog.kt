...
import com.example.cinemates.databinding.LayoutDialogMediaListBinding
 ...
 */
class MediaListDialog(
    private val context: Context,
    private val collection: Collection,
) {

    private lateinit var alertDialog: AlertDialog
    private lateinit var binding: LayoutDialogMediaListBinding
    private var adapter: MediaAdapter = MediaAdapter()

    fun showDialog() {
        val dialogBuilder = AlertDialog.Builder(context)
        binding = LayoutDialogMediaListBinding.inflate(LayoutInflater.from(context))
