 ...
 *
 * @property sortBy The sorting option for the media items. Default is [SortOptions.DescendingPopularity].
...
data class MediaDiscoverFilter(
    val sortBy: SortOptions? = SortOptions.DescendingPopularity,
