 ...
 *
 * @property sortBy The sorting option for the media items. Default is [BaseSortOptions.DescendingPopularity].
...
data class MediaDiscoverFilter(
    val sortBy: BaseSortOptions? = BaseSortOptions.DescendingPopularity,
